...
def inception(x, filters):
    ...
    # output = [None(batch_size), w(width), h(height), c(channel)], c 기준으로 concatenate
    # concatenate(), axis = -1 : channel(마지막 축) 기준으로 적층
...
loss = history.history['dense_5_loss']
